...
\begin{acronym}[neos]
    ...
    \acro{neos}[neos]{neural end-to-end-optimized summary statistics}
    \acro{tomatos}[TOMATOS]{auTOMATed Optimization of Sensitivity}
    ...
    \acro{mcp}[MCP]{Muon Combined Performance}
