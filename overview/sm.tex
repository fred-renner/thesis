...
\begin{figure}
    \centering
    \includegraphics[width=0.3\textwidth]{top_loop}
...
Therefore the yet unmeasured Higgs terms offer insight into physics at energies that were only present very shortly after the big bang far out of reach for any collider that could be constructed. With precise measurements of the top and Higgs masses and self-coupling the shape of the potential could be determined to provide an answer to the question of whether a false vacuum decay exists. Also since the Higgs seems to couple to everything that has mass it could also provide insight into matter that is not been discovered. Therefore the investigation of these parameters is a promising metaphysical endeavor to which this work attempts to contribute.
