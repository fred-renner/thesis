...
Fermions interact with fields via bosons specific to each force. The strong force is mediated by eight massless gluons $g$, while the electroweak theory includes four massless bosons $W_1,W_2,§,B$. The scalar Higgs particle plays a unique role in the \ac{sm}, breaking the electroweak interaction into weak and electromagnetic interactions through the Higgs mechanism. This process, detailed in section \ref{sec:higgs_mechanism}, explains the observed masses of weak interaction mediators $W^{\pm}$ and $Z$ and also provides an interpretation of the origins of mass for fermions.
...
Fields which appear in the \ac{sm} and their associated Lagrangians are summarized in table \ref{tab:fields}.
...
\red{This principle states that attempting to separate a hadron always results in the production of a quark-antiquark pair due to energetic favorability as will be elaborated on in section \ref{sec:qcd}. 
To comply with Pauli's exclusion principle, quarks in a bound state must have different color states.
This principle states that attempting to separate a hadron always results in the production of a quark-antiquark pair due to energetic favorability as will be elaborated on in section \ref{sec:qcd}. 
}
\begin{figure}[H]
    \centering
