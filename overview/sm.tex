...
\end{equation}
With the identity $V_L^uV_L^{d\dagger}\equiv V_\mathrm{CKM}$ the quark mixing matrix also called \ac{ckm} matrix mixes so that the physically observed states are mixtures of the mass eigenstates
\begin{equation}
    \begin{pmatrix}
        d' \\
        s' \\
