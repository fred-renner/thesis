...
Fermions interact with fields via bosons specific to each force. The strong force is mediated by eight massless gluons $g$, while the electroweak theory includes four massless bosons $W_1,W_2,W_3,B$. The scalar Higgs particle plays a unique role in the \ac{sm}, breaking the electroweak interaction into weak and electromagnetic interactions through the Higgs mechanism. This process, detailed in section \ref{sec:higgs_mechanism}, explains the observed masses of weak interaction mediators $W^{\pm}$ and $Z$ and also provides an interpretation of the origins of mass for fermions.
...
\red{Electroweak Renormalization
Renormalization for the electroweak sector is a complex topic that goes beyond the scope of this discussion. However, it is worth mentioning that it involves the renormalization of both the weak and electromagnetic interactions within the unified electroweak theory. This requires dealing with the mixing of the WW and ZZ bosons and the photon, and the treatment of spontaneous symmetry breaking and the Higgs mechanism. The process is crucial for ensuring the consistency and predictive power of the Standard Model, particularly at higher energy scales explored in particle accelerators. The knowledge presented in this chapter provides a foundational understanding of renormalization in QED and QCD, which can be extended to the electroweak theory with more advanced techniques and considerations.}



\section{Physics Beyond the Standard Model}\label{sec:beyond_sm}
\red{    shape, phase transition matter antimatter}
...
\red{ Thomson s. 450 weak sector measurable with high precision -->deviations bsm, relations that couple paramaters in EW, senstitive to loop corrections, }