...
\end{equation}
the equations of motions remain invariant. $SU(3)_C$ is the special unitary group of rank 3 representing the color symmetry within \ac{qcd}, the \ac{qft} describing the strong interactions. $SU(2)_L \otimes U(1)_Y$ exhibits the unification of the weak and electromagnetic interaction into the \ac{ew} force of that leave $SU(2)_L$ left-chiral particle doublets and particles carrying $U(1)_Y$ fermions with weak hypercharge $Y$.
...
\red{    In QED, the gauge bosons (photons) do not interact with each other. This is a direct consequence of the Abelian nature of U(1) In contrast, in non-Abelian gauge theories like Quantum Chromodynamics (QCD), the gauge bosons (gluons) do interact with each other due to the non-commuting nature of the gauge group generators.}
