...
\begin{align}
    ...
    u_R                                                                                                                        \\
                           & \phantom{-\;} +h.c.                                                                               \\
                           & = -G_e \overline{L}_L \phi e_R -G_d \overline{Q}_L \phi d_R -G_u \overline{L}_L \phi_c e_R + h.c.
\end{align}
with Yukawa coupling constant $G_e,G_d,G_u$ and the charge conjugated Higgs field $\phi_c=i\sigma_2\phi$. The latter can be used because it transforms just like the Higgs field and therefore leaves the Lagrangian gauge invariant. In the unitary gauge of equation \ref{eq:unitary_gauge} the terms become interpretable as mass terms that have the desired form of equation \ref{eq:yukawa_mass_term} but are now introduced gauge invariant and read e.g. for the electron
\begin{equation}
...
\end{equation}
The mass of fermion $f$ is therefore 
\begin{equation}
...
\end{equation}
Consequently the Higgs couples to fermions proportional to their mass.