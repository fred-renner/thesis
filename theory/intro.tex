...
\begin{align}
    \psi_{L} & \rightarrow e^{i \alpha_a(x) \sigma_a/2}e^{ iY/2} \psi_{L},\qquad \alpha\in\mathbb{R},\quad a\in\{1,\mathellipsis,3\} \\
    \psi_{R} & \rightarrow e^{ iY/2} \psi_{R}
\end{align}
...
\end{equation}
with triplet and quartic self-couplings proportional to the Higgs mass $m_h=\mu\sqrt{2}$. The kinematic term of the Higgs Lagrangian can be brought into a form that the gauge fields $W^1_\mu,W^2_\mu,W^3_\mu,B_\mu$ represent the physical fields of the charged massive $W^{\pm}$ gauge bosons
\begin{equation}
    W_\mu^\pm = \frac{1}{\sqrt{2}}(W_\mu^1\mp i W_\mu^2),
\end{equation}
the neutral massive $Z$ boson and a massless photon $A_\mu$ are mixed states of
\begin{equation}
    \begin{pmatrix}
        A_\mu \\
        Z_\mu
...
%     \end{pmatrix}
% \end{align}
From this follow the masses of the massive gauge bosons as
\begin{equation}
    m_W= \frac{1}{2}g_2v,\quad m_Z=\frac{1}{2}\sqrt{g_1^2+g_2^2}
\end{equation}
and the relation to the weak mixing angle
\begin{equation}
    \cos\theta_W=\frac{g_2}{\sqrt{g_1^2+g_2^2}}=\frac{m_W}{m_Z},
\end{equation}
which was verifiable before the Higgs discovery and a compelling argument for the Higgs to exist.
