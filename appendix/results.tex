\begin{figure}
    \centering
    \includegraphics[width=0.22\textwidth]{neos_results/m_hh_5_l1cvv0cv1/figures/ranking.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.22\textwidth]{neos_results/tomatos_bce_5_2500_ratios_op8_op5_l1cvv0cv1/figures/ranking.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.22\textwidth]{neos_results/tomatos_cls_5_2500_slope_50_ratios_0p8_0p5_l1cvv0cv1/figures/ranking.pdf}
