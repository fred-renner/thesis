...
\begin{figure}
    ...
    \subfigure[]{\includegraphics[width=.47\textwidth]{/Users/fred/phd/thesis/images/tomatos_cls_5_1000_unbound_shapesys/images/0185.png}}
    \caption[]{\red{Histograms used in the optimization after Kernel Density Estimation. hyperparameter tweaking it looses gradient if I go below bandwidth 0.2 }}
...
\red{auch zeigen sample kombinierungsplot für alle?}
\begin{figure}
    \centering
