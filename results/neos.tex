...
\begin{figure}
    ...
    \caption[]{Relative error per bin for the: (a) third \pt bin GN2X version of the $X\rightarrow bb$ tagger (b) alternative parton shower uncertainty on the signal and (c) background shape uncertainty to the nominal background estimate.}
