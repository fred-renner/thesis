...
\red{bins two things, degeneracy, kde too bad to estimate good enough the actual stat uncertainty in particular when bins become very small. the stat error should actually protect for this, but kde too smeared ~3 bins bandwidth 0.2 }
...
statistik ist of course das problem, nicht der fehler sondern die menge an daten, wie immer in nn training.
}
