...
\begin{figure}
    \centering
    \subfigure[]{\includegraphics[width=.47\textwidth]{relu_activation_function}}
    \subfigure[]{\includegraphics[width=.47\textwidth]{sigmoid_activation_function}}
