...
\end{align}
The prefactors of amplitudes in front of the couplings depend non-trivially on $\mhh$. However
rewritten as
\begin{align}
    \frac{d\sigma(\kvv, \kv, \kl )}{d \mhh}
...
\end{align}
and six given solutions a linear system of equations with variables $a_i$ can be solved and thus $\frac{d\sigma(\kl)}{d \mhh}(\kl)$ as a function of ($\kl$, $\kv$ and \ktwov) allows to deduce the cross-section for a desired hypothesis. 
