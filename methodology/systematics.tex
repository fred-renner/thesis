...
\red{put jet unceratainties here}
...
\begin{figure}
    ...
    \caption[]{Shape uncertainties for \textbf{(a)} Scale variations and \textbf{(b)} \ac{pdf} + $\alpha_s$.\red{redo}}
...
\begin{figure} 
    \centering
        \subfigure[]{\includegraphics[width=.47\textwidth]{tomatos_cls_5_NOSYS.VR_xbb_2_compareABCD}}
        \subfigure[]{\includegraphics[width=.47\textwidth]{tomatos_cls_5_SR_xbb_2_Background_bkg_estimate_shape}} 
